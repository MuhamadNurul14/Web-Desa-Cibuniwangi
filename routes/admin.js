...
router.get('/settings/profile', (req, res) => {
  res.render('admin/settings/profile', { title: 'Profil Admin', user: req.session.user });
});

router.get('/settings/kontak', (req, res) => {
  res.render('admin/settings/kontak', { title: 'Pengaturan Kontak', user: req.session.user });
});
...
router.get('/users', (req, res) => {
  res.render('admin/users/index', { title: 'Kelola Pengguna', user: req.session.user, data: [] });
});
...
router.get('/:page', (req, res, next) => {
  ...
  return res.render('admin/crud/index', {
    ...
    user: req.session ? req.session.user : null,
    activePage: page,
    items: [], // Array data kosong agar tabel tidak error
    fields: []
  });
});
